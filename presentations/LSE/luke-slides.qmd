...
- <https://www.luke-elson.org/presentations> for the slides.
...
- It looks like he should stop at some stage... but not today.

- Can we vindicate stopping?
...
- @Tuck2008 considers my favourite example: a shepherd wants to build cairns but not move heavy stones.

- I don't think anyone has given a convincing picture of how they work.

## The Sustainability Relevance

- Aldred uses the example of an unspoilt common.
...
- This picture fits naturally into orthodox
...
- Such principles are false but psychologically compelling.
...
- The slope is now determinately downwards, so turning the dial is clearly dispreferred.
...
- Instead of a single utility peak whose location is vague:
    - the curve is indeterminately rising or falling at each stage,
    - but determinately falls over longer ranges.

- This explains Nonsegmentation:
    - Taking the money is indeterminately preferred at each point, but *determinately not* over longer ranges.
  

## Life-Altering Pain Increases

- Stipulatively, a *life-altering* pain increase is
...
* ST's total utility function is the sum of these.
...
- Over every stretch of 10 dial-turns, they all decline. At
...
- We simply needed vagueness in how many dial-turns form a life-altering 'clump' of pain that ST cares about.
