...
#show: doc => article(
  ...
  authors: (
    ( name: [Luke Elson, luke.elson\@reading.ac.uk],
      affiliation: [],
      email: [] ),
    ),
  lang: "en",
...
- Since a life-altering pain increase outweighs \$100,000, let's assume it's worth -11 utils:

  - $u_p (n) = - 11 floor.l n \/ s floor.r$

- At many points, it's indeterminate whether ST prefers to turn the dial.

- Over every stretch of 10 dial-turns or longer, the lines all decline.

#figure([
#box(image("./new-utilities.svg"))
